...
export function UserUpdate() {
  ...
  async function waitFunction() {
    await sleep(1300); // Pause for 1.3 seconds (1300 milliseconds)
  }
  ...
  return (
    <div className="flex flex-col w-full h-screen items-center bg-[rgba(6,78,59,0.5)] text-slate-300">
      ...
      <div className="flex-row w-full max-w-2xl px-6 py-6">
        ...
        {currentStep == 1 && (
          <p className="text-gray-300 mb-4">Submit any name changes here...</p>
        )}
        {currentStep == 2 && (
          <p className="text-gray-300 mb-4">Changes to contact information</p>
        )}
        {currentStep == 3 && (
          <p className="text-gray-300 mb-4">Make any updates to your address</p>
        )}
        {currentStep == 4 && (
          <p className="text-gray-300 mb-4">Need to change your password?</p>
        )}
        {currentStep > totalSteps && (
      ...
      <div className="flex w-full max-w-2xl px-6 py-6 items-start justify-between gap- items-stretch ${currentStep === 4 ? 'justify-center' : 'justify-between'}">
        <div className="flex-grow">
          <form
            ...
            className="flex flex-col items-start bg-slate-500/70 border-black border-3 px-12 py-8 text-slate-200 rounded-2xl w-full shadow-black shadow overflow-auto opacity-97"
          >
            {/* Step 1 */}
            {currentStep === 1 && (
              <div className="flex gap-1 mt-1 flex-col w-full">
                <label className="label-col">
                  Change Name? (Existing = {oldFormData.fullname} )
                  <input
                    type="text"
            ...
            {currentStep === 2 && (
              <div className="flex flex-col gap-4 w-full">
                ...
                <label className="label-col">
                  Change Phone? (Existing = {oldFormData.phone})
                  <input
                    type="text"
                    name="phone"
                    className="input-element"
            ...
            {currentStep === 3 && (
              <div className="flex flex-col gap-4 w-full">
                <label className="label-col">
                  Change Address? (Existing Line One = {oldFormData.street1})
                  <input
                    type="text"
                    name="street1"
                    className="input-element"
                ...
                <label className="label-col">
                  New City? (Existing City = {oldFormData.city})
                  <input
                    type="text"
                    name="city"
                    className="input-element"
                ...
                <label className="label-col">
                  New State? (Existing State = {oldFormData.state})
                  <input
                    type="text"
                    name="state"
                    className="input-element"
                ...
                <label className="label-col">
                  New Zip Code? (Existing Zip = {oldFormData.zip})
                  <input
                    type="text"
                    name="zip"
                    className="input-element"
            ...
            {currentStep === totalSteps && (
              <div className="flex flex-col gap-4 w-full">
                <label className="label-col">
                  Enter your old password to submit.
                  <input
                    type="password"
