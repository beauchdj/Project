  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center">
      ...
      <main className="relative z-10 flex flex-col items-center gap-10">
        ...
        <div className="flex flex-col items-center justify-center cursor-pointer" onClick={toggleBox}>
          <h1 className="font-extrabold italic font-serif md:text-4xl text-center
        ...
        {isBoxOpen && (
          <div className="bg-gradient-to-r from-lime-300 to-emerald-900 p-2 rounded-xl shadow-2xl w-full max-w-2xl mx-auto transition-all duration-1000 transform scale-100 z-30 opacity-80" onMouseLeave={toggleBox}>
